...
<div class="flex flex-col gap-2 items-center justify-center py-2 w-full border-color-300 border rounded px-6 py-4">
    <h6 class="text-sm text-gray-900 font-bold">
        <?= $message ?> 😔
    </h6>
    <a href="<?= $oAuthUrl ?>"
       role="button"
